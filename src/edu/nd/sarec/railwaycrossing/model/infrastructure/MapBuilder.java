...
public class MapBuilder {
	...
	private void buildRoads(){
		...
		roads.put("EastWest",new Road(new Point(415,600),new Point (785,600),Direction.EAST,true,true));	
	}
	...
	private void buildTracks(){
		...
		tracks.put("Indigo", new RailwayTracks(new Point(0,550),new Point(1200,550)));
	}
